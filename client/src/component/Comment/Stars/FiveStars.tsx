...
const Custom5StarSVG = styled("svg")`
  .cls-1 {
    fill: #faaf00;
  }
`
...
const FiveStars = () => {
  return (
    <>
    <Custom5StarSVG id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 20">
      ...
      <polygon className="cls-1" points="68.25 2.39 70.14 8.2 76.25 8.2 71.3 11.8 73.19 17.61 68.25 14.02 63.31 17.61 65.2 11.8 60.25 8.2 66.36 8.2 68.25 2.39"/>
      <polygon className="cls-1" points="86.5 2.39 88.39 8.2 94.5 8.2 89.55 11.8 91.44 17.61 86.5 14.02 81.56 17.61 83.45 11.8 78.5 8.2 84.61 8.2 86.5 2.39"/>
    </Custom5StarSVG>
    </>
  )
}
